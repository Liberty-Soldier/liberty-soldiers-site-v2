    ...
    <header className="sticky top-0 z-50 backdrop-blur bg-black/60 border-b border-white/10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <nav className="hidden md:flex items-center gap-6 text-sm">
          <Link href="/news" className="hover:text-white/80">
            News
          </Link>

          <Link href="/published" className="hover:text-white/80">
            Articles
          </Link>

          <Link href="/reports" className="font-semibold text-white">
            Reports
          </Link>

          <Link href="/community" className="hover:text-white/80">
            Community
          </Link>

          <Link href="/store" className="hover:text-white/80">
            Store
          </Link>
