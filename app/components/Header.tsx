  ...
  <header className="sticky top-0 z-50 border-b border-zinc-200 bg-white/95 backdrop-blur-md">
    <div className="border-b border-white/10 bg-gradient-to-r from-zinc-950 to-zinc-900 text-white">
      <div className="mx-auto flex h-8 max-w-7xl items-center px-4 sm:px-6 lg:px-8">
        <div className="flex items-center gap-2 text-[11px] font-semibold tracking-wide text-white">
    ...
    {open && (
      <nav className="fixed left-0 right-0 top-[96px] z-50 flex flex-col gap-3 border-b border-zinc-200 bg-white px-4 py-4 shadow-lg md:hidden">
        {NAV_ALL.map((item) => {
          const Icon = item.icon;
          return (
            <Link
