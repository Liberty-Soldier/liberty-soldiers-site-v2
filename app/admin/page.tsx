    ...
    <main className="min-h-screen bg-white text-zinc-900">
      <article className="mx-auto max-w-3xl px-4 py-10">
        <div className="mb-6">
          ...
          <h1 className="text-4xl font-semibold tracking-tight">${item.title.replace(/</g, "&lt;").replace(/>/g, "&gt;")}</h1>
          ...
          <section className="space-y-6">
            ...
            {activeTab === "export" && (
              <div className="space-y-6">
                ...
                <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
                  <h2 className="text-xl font-semibold tracking-tight">Self-Contained page.tsx Template</h2>
                  <p className="mt-1 text-sm text-zinc-600">
                ...
                <div className="rounded-3xl border border-zinc-200 bg-white p-6 shadow-sm">
                  ...
                  <div className="mt-4 space-y-3 text-sm leading-6 text-zinc-700">
                    ...
                    <p>
                      2. Replace mock queue state with real persistence.
                    </p>
                    <p>
                      3. Add API routes for intake, save draft, approve, and publish.
                    </p>
                    <p>
                      4. Add bot generation later so sources become first-pass LBS drafts automatically.
                    </p>
                  </div>
                </div>
              </div>
